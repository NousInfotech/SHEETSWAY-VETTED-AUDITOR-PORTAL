...
//     />
//     <div className='mb-4 flex flex-col justify-between gap-2 md:flex-row md:items-center'>
//       <h2 id='files-heading' className='text-xl font-semibold text-gray-800'>
//         {heading}
//       </h2>
//       <div className='flex flex-wrap items-center gap-2'>
//         <Button
...
//     if (!selectedLibraryId || !selectedSubfolderId) {
//       toast.error('Could not delete files: selection is invalid.');
//       return;
//     }
