...
//           payoutCurrency: data.payoutCurrency || undefined,
//           // --- THE FINAL FIX IS HERE: Add the missing required fields ---
//           accountStatus: 'VERIFIED', // Required by AuditorSchema
//           role: 'SUPERADMIN' // Required by AuditorSchema
//         }
//       };
...
//         } else {
//           errorMessage =
//             responseData.message || 'Server responded with an error.';
//         }
...
//                   )}
//                 />
//                 {/* Added registeredOn date picker field */}
//                 <FormField
//                   control={form.control}
//                   name='registeredOn'
//                   render={({ field }) => (
