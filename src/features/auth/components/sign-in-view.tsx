...
//         style={{
//           backgroundSize: 'cover', // Changed from specific px values
//           backgroundPosition: 'center center', // Changed from specific px values
...
//           <div className='embla flex h-full items-center justify-center' ref={emblaRef}>
//             <div className='embla__container flex h-full'>
//               {' '}
//               {/* Added h-full here too */}
//               {/* Slides */}
